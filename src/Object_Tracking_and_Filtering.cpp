...
void createTrackbars(){
	...
	sprintf( TrackbarName, "minimum_H", minimum_H);
	sprintf( TrackbarName, "maximum_H", maximum_H);
	sprintf( TrackbarName, "minimum_S", minimum_S);
	sprintf( TrackbarName, "maximum_S", maximum_S);
	sprintf( TrackbarName, "minimum_V", minimum_V);
	sprintf( TrackbarName, "maximum_V", maximum_V);
...
int main(int argc, char* argv[])
{
	...
	vidCapture.set(CV_CAP_PROP_widthFrame,widthFrame);
	vidCapture.set(CV_CAP_PROP_heightFrame,heightFrame);
